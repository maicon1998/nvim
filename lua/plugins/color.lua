return {
	...
	config = function()
		...
		local color1 = hsl(150, 70, 65) -- Function name
		local color2 = hsl(150, 70, 40) -- Data type
		local color3 = foreground -- Statement, PreProc, Operator
		...
		local theme = lush(function(injected_functions)
			...
			return {
				...
				Visual({ fg = background, bg = foreground }), -- Visual mode selection
				...
				Function({ fg = color1 }), --   Function name (also: methods for classes)

				Statement({ fg = color3, gui = "bold" }), -- (*) Any statement
				-- Conditional    { }, --   if, then, else, endif, switch, etc.
				-- Repeat         { }, --   for, do, while, etc.
				-- Label          { }, --   case, default, etc.
				Operator({ fg = color3, gui = "bold" }), --   "sizeof", "+", "*", etc.
				-- Keyword        { }, --   any other keyword
				-- Exception      { }, --   try, catch, throw

				PreProc({ fg = color3, gui = "bold" }), -- (*) Generic Preprocessor
