...
local foreground = "#00ffbf"
local fg_light_30 = "#009973"
local fg_light_40 = "#00cc99"
local fg_light_70 = "#66ffd9"
	...
	config = function()
		...
		local theme = lush(function(injected_functions)
			...
			return {
				...
				SpecialKey({ fg = fg_light_70 }), -- Unprintable characters: text displayed differently from what it really is. But not 'listchars' whitespace. |hl-Whitespace|
				...
				Visual({ fg = background, bg = fg_light_40 }), -- Visual mode selection
				...
				-- SYNTAX
				Comment({ fg = fg_light_30 }), -- Any comment
				Constant({ fg = fg_light_70 }), -- (*) Any constant
				String({ fg = fg_light_40 }), --   A string constant: "this is a string"
				...
				sym("@variable")({ fg = fg_light_70 }), -- Identifier
				-- sym"@type"              { }, -- Type
